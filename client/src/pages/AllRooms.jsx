  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col items-start text-left'>
            ...
            <p className='text-sm md:text-base text-gray-500/900 mt-2 max-w-174'>Take advantage of our limited-time offers an special packages to enchance you stay and create unforgettable memories.</p>
        </div>
...
border-b border-gray-300 last:pb-30 last:border-0'>
                    <img onClick={()=>{navigate(`/rooms/${room._id}`);scroll(0,0)}}
                src={room.images[0]} alt='hotel-img'title='View Room Details'
                className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer'/>
                <div className='md:w-1/2 flex flex-col gap-2'>
                    <p className='text-gray-500'>{room.hotel.city}</p>
                    <p onClick={()=>{navigate(`/rooms/${room._id}`);scroll(0,0)}}
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className='flex items-center gap-1 text-gray-500 mt-2 text-sm'>
                            ...
                            <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                                ...
                                <p className='text-xl font-medium text-gra-700'>₹{room.pricePerNight}/Night</p>
                    </div>
            </div>
        ))}
